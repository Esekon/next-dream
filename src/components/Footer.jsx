          ...
          <section className="row text-white bg-dark p-4">
            ...
            <div className="col-md-4">
              ...
              <Link to="https:/facebook.com">
                <img src={fblogo} alt="" width="50px" height="50px" style={{marginRight: "20px" }} />
              </Link>
              <Link to="https://instagram.com/_.3guman_">
                <img src={instalogo} alt="" width="50px" height="50px" style={{marginRight: "20px" }}/>
              </Link>
              <Link to="https://whatsApp.com/254742208491" aria-label="WhatsApp">
                <img src={whatsapplogo} alt="" width="50px" height="50px"/>
              </Link>
